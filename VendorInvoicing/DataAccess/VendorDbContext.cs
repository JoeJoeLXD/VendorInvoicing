    ...
    public class VendorDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Vendor>()
                .Navigation(v => v.Invoices)
                .AutoInclude();

            modelBuilder.Entity<Invoice>()
                .Navigation(i => i.Vendor)
                .AutoInclude();

            modelBuilder.Entity<Invoice>()
                .Navigation(i => i.InvoiceLineItems)
                .AutoInclude();

            modelBuilder.Entity<InvoiceLineItem>()
                .Navigation(ili => ili.Invoice)
                .AutoInclude();

            modelBuilder.Entity<PaymentTerms>()
                .Navigation(pt => pt.Invoices)
                .AutoInclude();
            ...
            // setup 1-to-many between invoice & line item:
            modelBuilder.Entity<InvoiceLineItem>().HasOne(ili => ili.Invoice).WithMany(i => i.InvoiceLineItems).HasForeignKey(i => i.InvoiceId);
